//
//  SRDExceptionErrorSwiftTests.swift
//  SRDTestUtilities
//
...
// MARK: - SRDExceptionErrorSwiftTests Definition

class SRDExceptionErrorSwiftTests: XCTestCase {
    ...
    func testGenericExceptionCase() {
        ...
        XCTAssertEqual(error.localizedDescription, "SRDExceptionError: \(exception.reason ?? "")")
    }
